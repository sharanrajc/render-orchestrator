...
PROMPTS = {
    ...
    "EXISTING_V2": "I see an application linked to this number. Please say “continue”, “modify”, or “start new application.”",
    ...
    "ASK_NAME_V2": "To start, please say your full legal name — for example, “Joe Smith.”",
    ...
    "ASK_INCIDENT_DATE": "On what date did the incident occur? You can say the month, day, and year, like “August 24, 2025.”",
